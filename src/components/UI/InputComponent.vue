<template>
  ...
  <div class="input-component">
    <div class="input-container">
      <label class="input-description input-text-settings input-focused">{{ inputSettings.placeholder }}</label>
      <input
        class="input input-text-settings"
    ...
    <div class="input-buttons-container">
      <template v-if="inputSettings.hasEditButton">
      ...
      <template v-if="inputSettings.hasVisibleButton">
        <button class="visible-button" type="button">
...
const props = defineProps({
  inputSettings: { type: Object, required: true }
})

const emit = defineEmits(['update:inputSettings'])
