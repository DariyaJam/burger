...
const props = defineProps({
  width: { type: Number, default: defaultSize },
  height: { type: Number, default: defaultSize }
})
</script>
...
<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"
    ...
    <path style="transform:scale(0.8);transform-origin:50px 50px" stroke-linecap="round"
          ...
          stroke-dasharray="42.76482137044271 42.76482137044271" stroke-width="8" stroke="#4c4cff" fill="none">
